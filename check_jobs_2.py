...
COMPANIES = [
    ...
    "Starbucks", "McDonalds", "Tesco", "Sainsburys", "Bolt",
...
COUNTRY = "gb"
MAX_DAYS_OLD = 1
STATE_FILE = os.path.join(os.path.dirname(__file__), "..", "seen_jobs_2.json")
...
def format_email(new_ads):
    ...
    body["Subject"] = "New job posting(s) - Batch 2 (" + str(len(new_ads)) + ")"
